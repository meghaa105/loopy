                  ...
                  <div className="flex items-center -space-x-4">
                    {loop.members.slice(0, 4).map(member => (
                      <img 
                        key={member.id} 
                        src={member.avatar} 
                        className="w-12 h-12 rounded-full border-2 border-black grayscale group-hover:grayscale-0 transition-all" 
                        title={member.name}
                      />
                    ))}
                    {loop.members.length > 4 && (
                      <div className="w-12 h-12 rounded-full bg-white border-2 border-black flex items-center justify-center text-[10px] font-black">
                        +{loop.members.length - 4}
                      </div>
                    )}
                  </div>
